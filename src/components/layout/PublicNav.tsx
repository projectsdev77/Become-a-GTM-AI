    ...
    <header className="border-b border-hairline">
      <nav className="mx-auto flex max-w-[1160px] items-center justify-between gap-4 px-6 py-4">
        ...
        <div className="flex items-center gap-6">
          <Link to="/" className="hidden font-body text-[13px] font-medium text-muted no-underline hover:text-display sm:inline">
            Home
          </Link>
          <Link
            to="/curriculum"
            className="hidden font-body text-[13px] font-medium text-muted no-underline hover:text-display sm:inline"
          >
            Curriculum
          </Link>
          <Link to="/login" className="font-body text-[13px] font-medium text-muted no-underline hover:text-display">
            Log in
          </Link>
