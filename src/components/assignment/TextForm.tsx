    ...
    >
      <div className="relative">
        <TextAreaField
          ...
          error={tooLong}
        />
        <span className="pointer-events-none absolute bottom-3 right-4 font-mono text-[11px] font-semibold text-muted">
          {words} words
        </span>
      </div>
      <p className={`text-[13px] ${tooShort || tooLong ? 'font-semibold text-warn-ink' : 'text-muted'}`}>
