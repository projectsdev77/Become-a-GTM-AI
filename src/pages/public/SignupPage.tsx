    ...
    return (
      <div className="min-h-screen bg-ground">
        ...
        <main className="flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-[440px] rounded-shell border border-line p-10 text-center">
    ...
    <div className="min-h-screen bg-ground">
      ...
      <main className="mx-auto flex max-w-[1160px] flex-wrap items-stretch gap-6 px-6 py-10">
        <section className="min-w-[280px] flex-1 flex-[1_1_400px]">
          <IllustrationSlot minHeight={520} className="h-full w-full rounded-shell" />
        </section>
        ...
        <section className="flex min-w-[280px] flex-1 flex-[1_1_400px] flex-col rounded-shell border border-line p-10">
          ...
          <p className="mt-2.5 text-sm text-text-muted">No card needed to finish the first week.</p>
