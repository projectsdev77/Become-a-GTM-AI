  ...
  return (
    <div className="min-h-screen bg-ground">
      ...
      <main className="mx-auto max-w-[700px] px-4 py-10 sm:px-6">
        ...
        <h1 className="mt-2 font-display text-[clamp(28px,4vw,38px)] uppercase tracking-[-0.01em] text-display">Messages</h1>
        ...
        <div className="mt-6 flex items-center gap-3 border-b border-hairline pb-5">
          ...
          <div>
            <p className="text-[15px] font-bold text-heading">Your mentor</p>
            <p className="font-mono text-[10.5px] uppercase tracking-[0.06em] text-muted">Mentor</p>
          </div>
        </div>
