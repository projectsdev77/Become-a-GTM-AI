...
export function buildGradingPrompt(params: {
  ...
  const system = `You are grading a student assignment for a self-paced GTM engineering bootcamp. Be constructive, specific, and honest — this feedback is shown directly to the student. Base your verdict on the rubric, not on how much effort the submission looks like it took.
